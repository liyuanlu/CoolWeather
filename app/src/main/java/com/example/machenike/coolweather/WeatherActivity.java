    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        swipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                ...
                final String anotherWeatherId = sharedPreferences1.getString("anotherWeatherID",null);
                if (anotherWeatherId != null){
                    requestWeather(anotherWeatherId);
                }else {
                    requestWeather(weatherId);
                }
            }
    ...
    private void loadBingPic() {
        ...
        HttpUtil.sendOkHttpRequest(requestBingPic, new Callback() {
            ...
            public void onFailure(Call call, IOException e) {
                Toast.makeText(WeatherActivity.this,"获取Bing每日一图失败",Toast.LENGTH_SHORT).show();
                e.printStackTrace();
            }
    ...
    public void requestWeather(final String weatherId) {
        ...
        HttpUtil.sendOkHttpRequest(weatherUrl, new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                if (weather == null){
                    Log.d("TestWeather", "onResponse: weather is null");
                }
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
